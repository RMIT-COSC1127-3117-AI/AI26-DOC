...
- [FAQ - EdStem Forum](#faq---edstem-forum)
  ...
  - [Cannot see videos in EdStem: "Playback isn't supported on this device". What can I do?](#cannot-see-videos-in-edstem-playback-isnt-supported-on-this-device-what-can-i-do)
...
In fact, since 2026, the School of Computing Techology (SCT) has adopted EdStem as the forum for many courses. 👍
...
## Cannot see videos in EdStem: "Playback isn't supported on this device". What can I do? 

Do you get this?

![alt text](imgs/playback-not-supported.png)

If so, check [this post](https://www.reddit.com/r/firefox/comments/1ufe7rg/playback_isnt_supported_on_my_device/), in my case the problem was extension "Enhancer for YouTube™" which I had to disable. After that, videos played fine.
